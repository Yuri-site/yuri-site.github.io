        ...
        <footer className="bg-pink-200 text-black px-6 py-8 text-sm">
            <div className="max-w-6xl flex flex-col ml-6 md:mx-auto md:flex-row justify-between items-start gap-6">
                ...
                <div className=" font-chenyu">
                    ...
                    <p className="tracking-widest text-3xl">YURISAKA</p>
                </div>

                {/* 導覽連結 */}
                <div className="grid grid-cols-2 gap-x-8 gap-y-2 text-sm">
                    <a href="#" className="hover:underline">關於我們</a>
                    <a href="#" className="hover:underline">贊助我們</a>
                    <a href="#" className="hover:underline">隱私政策</a>
                    <a href="#" className="hover:underline">作品補充表單</a>
                    <a href="#" className="hover:underline">免責聲明</a>
                    <a href="#" className="hover:underline">網站建議及問題回報</a>
                </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-xs">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <a href="mailto:yurisaka0000@gmail.com" className="text-md hover:underline">
                        yurisaka0000@gmail.com
                    </a>
                </div>
            </div>
        </footer>
